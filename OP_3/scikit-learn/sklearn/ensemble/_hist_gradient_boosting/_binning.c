...
{
    Py_ssize_t __pyx_tmp_idx = __pyx_v_feature_idx;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_binned.shape[1];
...
static PyMethodDef __pyx_methods[] = {
  {"_map_to_bins", (PyCFunction)__pyx_pw_7sklearn_8ensemble_23_hist_gradient_boosting_8_binning_1_map_to_bins, METH_VARARGS|METH_KEYWORDS, __pyx_doc_7sklearn_8ensemble_23_hist_gradient_boosting_8_binning__map_to_bins},
  {"_map_num_col_to_bins", (PyCFunction)__pyx_pw_7sklearn_8ensemble_23_hist_gradient_boosting_8_binning_3_map_num_col_to_bins, METH_VARARGS|METH_KEYWORDS, __pyx_doc_7sklearn_8ensemble_23_hist_gradient_boosting_8_binning_2_map_num_col_to_bins},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec__binning(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init sklearn.ensemble._hist_gradient_boosting._binning", 0, __pyx_lineno, __pyx_filename);
    }
